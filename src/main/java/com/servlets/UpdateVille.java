...
public class UpdateVille extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String codeCommune = ville.getCodeComune();
		...
		this.getServletContext().getRequestDispatcher("/infoVille.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ville.setCodeComune(session.getAttribute("codeCommune").toString());
		...
		HttpResponse<Ville> res = Unirest.put("http://localhost:8080/villeC?codeCommune="+idCodeCommune).header("Content-Type", "application/json")
