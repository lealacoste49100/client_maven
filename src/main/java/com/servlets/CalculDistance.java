...
public class CalculDistance extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int km = calculateDistanceInKilometer(Double.parseDouble(ville1.getLatitude()), Double.parseDouble(ville1.getLongitude()), Double.parseDouble(ville2.getLatitude()), Double.parseDouble(ville2.getLongitude()));
		...
		this.getServletContext().getRequestDispatcher("/calculerDistance.jsp").forward(request, response);
	}
